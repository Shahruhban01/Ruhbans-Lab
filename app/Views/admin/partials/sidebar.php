...
<aside class="admin-sidebar" data-admin-sidebar>
    ...
    <nav class="admin-nav" aria-label="Admin navigation">
        ...
        <a class="admin-nav__link" data-bs-toggle="collapse" href="#membershipsSubmenu" role="button" aria-expanded="false" aria-controls="membershipsSubmenu">
        ...
        <div class="collapse show" id="membershipsSubmenu">
            <div class="ps-3 d-flex flex-column gap-1 mt-1">
                <a class="admin-nav__link py-2" href="<?php echo e(url('/admin/memberships')); ?>">
                    Active Members
                </a>
                <a class="admin-nav__link py-2" href="<?php echo e(url('/admin/memberships/revenue')); ?>">
                    Revenue & Analytics
                </a>
                <a class="admin-nav__link py-2" href="<?php echo e(url('/admin/memberships/coupons')); ?>">
                    Discount Coupons
                </a>
